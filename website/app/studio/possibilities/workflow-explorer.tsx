...
const connections = [
  { id: "google", label: "Google Workspace", apps: ["Gmail", "Calendar", "Drive", "Forms"], title: "Keep the tools you know. Give the work a clearer path.", text: "An AI assistant could read an enquiry in context, find the relevant information in your chosen Drive folders and prepare a useful reply with links to its sources. A confirmed arrangement could then become a Studio task, a Calendar booking and the right welcome material—without you translating the conversation into every app.", flow: ["An enquiry in Gmail", "Next step in Studio", "Time in Calendar", "A resource from Drive"], need: "Less clicks. More time" },
  { id: "microsoft", label: "Microsoft 365", apps: ["Outlook", "Teams", "OneDrive"], title: "Let a small team work from the same understanding.", text: "Ask “What still needs sorting before Monday’s group?” An assistant could bring together the relevant Outlook threads, Studio tasks and approved OneDrive material into a brief with sources and unresolved questions. Turn the agreed next steps into a Teams handoff, so the team can act on the same understanding.", flow: ["An Outlook conversation", "A shared plan in Studio", "A Teams handoff", "An agreed resource"], need: "A handoff someone can actually pick up." },
