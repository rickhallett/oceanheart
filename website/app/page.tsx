...
export default function Home() {
 return <main className="oceanheart-home integrated-home">
  ...
  <section className="practice-index" id="work" aria-labelledby="practice-title">
   <div className="practice-intro"><p className="eyebrow">The through line</p><h2 id="practice-title">How are you with what’s happening?</h2></div>
   ...
   <div className="practice-list">
    <Link className="practice-item" href="/practice"><span className="practice-number">01</span><span><strong>Following your experience</strong><span className="practice-description">ACT, breathwork, somatic inquiry and hands-on work offer different ways into the same exploration. We choose together what belongs in your session.</span><span className="practice-read">How I work <ArrowIcon /></span></span></Link>
    <Link className="practice-item" href="/sessions"><span className="practice-number">02</span><span><strong>An invitation, at every step</strong><span className="practice-description">You can lean into an experience, slow down, change direction or decline an invitation. We make time to step back and understand what we’re doing together.</span><span className="practice-read">What a session can be like <ArrowIcon /></span></span></Link>
    <Link className="practice-item" href="/events"><span className="practice-number">03</span><span><strong>Practising in company</strong><span className="practice-description">Space for meditation, breathwork and somatic movement classes. Dates and venues will be shared here when confirmed.</span><span className="practice-read">Events & classes <ArrowIcon /></span></span></Link>
   </div>
